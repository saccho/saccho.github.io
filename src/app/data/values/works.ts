...
const works = [
  {
    ...
    imgPath: nagaoka,
    url:
      "https://play.google.com/store/apps/details?id=io.joren.nagaokamatsuri",
    description:
      "Product: Fuller, Inc. (joined as part-time job of Android engineer)",
  ...
  },
  {
    ...
    imgPath: kawaya,
    url:
      "https://github.com/ExciteJapanPub/summer-intern-2018-blockchain-fabric",
